...
WebUI.setText(findTestObject('Page_Recherche/input_Adresse MAC_form-control'), GlobalVariable.MAC_LIVEBOX2)
...
String ExpectedValue = GlobalVariable.MAC_LIVEBOX2
