...
WebUI.setText(findTestObject('Page_Recherche/input_Login_form-control input'), GlobalVariable.LOGIN_ALCL)
...
WebUI.waitForElementPresent(findTestObject('Page_Recherche/table_Etat'), 10)

String ExpectedValue = GlobalVariable.LOGIN_ALCL
    ...
    Loop: for (int row = 0; row < rows_count; row++) {
        ...
        for (int column = 0; column < columns_count; column++) {
            ...
            if (celltext == ExpectedValue) {
                ...
                println('Le Login recherché est : ' + Columns_row.get(column).getText())
