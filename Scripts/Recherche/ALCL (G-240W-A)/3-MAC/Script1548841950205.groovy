...
WebUI.setText(findTestObject('Page_Recherche/input_Adresse MAC_form-control'), GlobalVariable.MAC_ALCL)
...
String ExpectedValue = GlobalVariable.MAC_ALCL
...
WebUI.clearText(findTestObject('Page_Recherche/input_Adresse MAC_form-control'))
