...
WebUI.setText(findTestObject('Page_Recherche/input_Numro de tlphone_form-co'), GlobalVariable.ND_ALCL)
...
String ExpectedValue = GlobalVariable.ND_ALCL
    ...
    Loop: for (int row = 0; row < rows_count; row++) {
        ...
        for (int column = 0; column < columns_count; column++) {
            ...
            if (celltext == ExpectedValue) {
                ...
                println('Le ND recherché est : ' + Columns_row.get(column).getText())
...
WebUI.clearText(findTestObject('Page_Recherche/input_Numro de tlphone_form-co'))
