...
WebUI.waitForElementClickable(findTestObject('Page_Recherche/select_ZTEFanvilALCATEL'), 10)

int NbreElement = WebUI.getNumberOfTotalOption(findTestObject('Page_Recherche/select_ZTEFanvilALCATEL'))

println('Total element : ' + NbreElement)

WebUI.selectOptionByLabel(findTestObject('Page_Recherche/select_ZTEFanvilALCATEL'), 'ZTEG', false)
...
for (int row = 2; row < rows_count; row++) {
	...
	String  codeconstructeur = celltext.substring(0 , 3)
